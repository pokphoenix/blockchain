...
public class BlockChain {
    ...
    public static void main(String[] args) {
        ...
        String blockchainJson2 = new GsonBuilder().setPrettyPrinting().create().toJson(UTXOs);
        System.out.println("\nThe block chain 2: ");
        ...
        String blockchainJson3 = new GsonBuilder().setPrettyPrinting().create().toJson(UTXOs);
        System.out.println("\nThe block chain 3: ");
        ...
        String blockchainJson4 = new GsonBuilder().setPrettyPrinting().create().toJson(UTXOs);
        System.out.println("\nThe block chain 4: ");
        System.out.println(blockchainJson4);

        Block block4 = new Block(block3.hash);
        System.out.println("\nWalletB is Attempting to send funds (20) to WalletA...");
        block4.addTransaction(walletB.sendFunds(walletA.publicKey, 20f));
        // addBlock(block3);
        System.out.println("\nWalletA's balance is: " + walletA.getBalance());
        System.out.println("WalletB's balance is: " + walletB.getBalance());

        String blockchainJson5 = new GsonBuilder().setPrettyPrinting().create().toJson(UTXOs);
        System.out.println("\nThe block chain 5: ");
        System.out.println(blockchainJson5);

        String blockchainJson6 = new GsonBuilder().setPrettyPrinting().create().toJson(blockchain);
        System.out.println("\nThe block chain 6: ");
